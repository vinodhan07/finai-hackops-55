...
CREATE INDEX IF NOT EXISTS idx_savings_goals_tenant_id ON public.savings_goals(tenant_id);
CREATE INDEX IF NOT EXISTS idx_financial_goals_user_id ON public.financial_goals(user_id);
CREATE INDEX IF NOT EXISTS idx_financial_goals_tenant_id ON public.financial_goals(tenant_id);
...
CREATE INDEX IF NOT EXISTS idx_investments_tenant_id ON public.investments(tenant_id);
